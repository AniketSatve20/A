...
exports.disputeApi = void 0;
const express_1 = require("express");
const router = (0, express_1.Router)();
exports.disputeApi = router;
// In-memory storage
...
// Create dispute
router.post('/', (req, res) => {
    const { projectId, clientAddress, freelancerAddress, description, } = req.body;
...
//# sourceMappingURL=api-disputes.js.map